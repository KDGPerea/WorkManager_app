  ...
  return (
    <header>
      <div className="container">
        <Link to="/" className="logo-Colabora">
          <img src={workmanagerlogo} alt="logo de la compañía" />
          <h2 className="nombre-empresa">ColaboraNet</h2>
        </Link>
        <nav>
          <ScrollLink to="somosColabora" smooth={true} duration={500} className='scroll_link'>Acerca de</ScrollLink>
          <ScrollLink to="demostracion" smooth={true} duration={500} className='scroll_link'>Beneficios</ScrollLink>
          {user ? (
